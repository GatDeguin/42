...
import bpy,bmesh,ast,json,hashlib,math
from pathlib import Path
from mathutils import Vector
R=Path(r'D:/2026/42');S=bpy.context.scene;S.frame_set(150);bpy.context.view_layer.update()
...
(R/'review99/service_access_r7d.json').write_text(json.dumps(r,ensure_ascii=False,indent=2),'utf8');print(json.dumps(r,ensure_ascii=True),flush=True)
