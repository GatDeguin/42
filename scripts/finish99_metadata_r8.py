"""Finish R8 semantic collection membership and authored still-camera formats.
...
def apply():
 ...
 for o in list(S.objects):
  if not o.name.startswith(('R7B |','R8B |')):continue
 ...
 S['r8_presentation_metadata']=json.dumps(dict(objects=rows,cameras=cameras),ensure_ascii=False)
