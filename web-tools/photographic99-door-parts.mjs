...
export function addDoorPartMotion(document,info){
 const reference=JSON.parse(fs.readFileSync('docs/preview99/assets/source-envelopes.json'));if(reference.sourceSHA256!==info.stats.source_sha256)throw new Error('Door motion reference SHA differs');
