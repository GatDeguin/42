...
const out=process.env.PHOTO99_DOCS_QA_OUT||'review99/r7d_deliverables_qa';fs.mkdirSync(out,{recursive:true});
const SHA='9cf1a0e2f1b1a6063a28942623f20bc25b1b1ef423471a284b052ed7acffc54e';
const report={url:base,sourceSHA256:SHA,errors:[],pages:[],videoRendered:false,scope:'Document/gallery image loading, responsive layout, links and image dialog. Independent architectural and photographic approval is separate.'};
...
try{
 for(const [key,w,h,mobile] of [['desktop',1440,1000,false],['mobile',390,844,true]]){
  ...
  for(const section of ['renders99','planos99']){
   await p.goto(base+section+'/',{waitUntil:'networkidle'});
